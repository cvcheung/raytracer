...
// the diffuse effect.
func (d DiffuseLight) Scatter(rayIn *primitives.Ray, attenuation *textures.Color, rec *HitRecord, depth int, light Light, shadow bool) (bool, *primitives.Ray) {
...
// GetAmbient ...
func (d DiffuseLight) GetAmbient() textures.Color {
